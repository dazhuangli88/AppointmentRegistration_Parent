package com.fugui.hospital.service.impl;
...
public class ApiServiceImpl implements ApiService {
    ...
    public JSONObject getHospital() {
        ...
        JSONObject respone = HttpRequestHelper.sendRequest(paramMap,this.getApiUrl()+"/api/hospital/hospital/show");
    ...
    public boolean saveHospital(String data) {
        ...
        JSONObject respone = HttpRequestHelper.sendRequest(paramMap,this.getApiUrl()+"/api/hospital/saveHospital");
        System.out.println(respone.toJSONString());
    ...
    public boolean saveDepartment(String data) {
        ...
        for(int i=0, len=jsonArray.size(); i<len; i++) {
            ...
            paramMap.put("timestamp", HttpRequestHelper.getTimestamp());
            paramMap.put("sign",MD5.encrypt(this.getSignKey()));
            JSONObject respone = HttpRequestHelper.sendRequest(paramMap,this.getApiUrl()+"/api/hospital/saveDepartment");
            System.out.println(respone.toJSONString());
