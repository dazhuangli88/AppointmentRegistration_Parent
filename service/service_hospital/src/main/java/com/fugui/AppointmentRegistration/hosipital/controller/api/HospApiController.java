...
public class HospApiController {
    ...
    @GetMapping("showHospDetail/{hoscode}")
    public Result showHospDetail(@PathVariable String hoscode){
        Map<String, Object> map = hospitalService.item(hoscode);
        return Result.ok(map);
    }
    ...
    //！！！生成挂号订单流程：需要就诊人id和排班id，第二步先获取排班id，（获取排班下单信息和规则信息）如下
    //根据排班id获取预约下单数据
    ...
    //！！！生成挂号订单流程：第三步获取医院签名信息，然后通过接口去医院预约下单，如下
    //根据医院编号获取医院签名信息
